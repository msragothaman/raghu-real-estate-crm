    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-[#6C3BFF] hover:bg-[#5A2FE0] text-white text-sm font-bold px-4 py-2 rounded-xl shadow-sm transition-all"
        >
          <PlusCircle className="w-4 h-4" />
          <span>Add Plot(s) to Site</span>
        </button>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden">
          ...
          <div className="absolute bottom-5 left-5 right-5 text-white flex flex-col sm:flex-row sm:items-end justify-between gap-3">
            ...
            {site.maps_url && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 bg-white text-slate-900 hover:bg-purple-50 text-xs font-bold px-3.5 py-2 rounded-xl transition-all shadow-sm shrink-0"
              >
        ...
        <div className="p-5 sm:p-6 grid grid-cols-1 md:grid-cols-3 gap-4 border-b border-slate-100">
          <div>
        ...
        <div className="p-4 bg-slate-50/70 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3 text-center">
          <div className="p-2.5 bg-white rounded-xl border border-slate-200/80">
            <span className="text-xs font-semibold text-slate-500 block">Total Plots</span>
          ...
          <div
            ...
            className={`p-2.5 rounded-xl border cursor-pointer transition-all ${
              statusFilter === 'SOLD'
                ? 'bg-purple-50 border-[#DDD1FF] ring-2 ring-[#6C3BFF]/20'
      ...
      <div className="bg-white p-5 sm:p-6 rounded-2xl border border-slate-200/80 shadow-xs">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div>
            <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
              ...
              <span>Plot Inventory Matrix</span>
            </h3>
            <p className="text-xs text-slate-500">
              Click any plot to view details, update status, change buyer, or assign CRM leads.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-[#6C3BFF] w-44"
              />
            </div>
            ...
            <select
              ...
              className="px-2.5 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-xl font-medium text-slate-700 focus:outline-none focus:border-[#6C3BFF]"
            >
            ...
            {(statusFilter !== 'ALL' || facingFilter !== 'ALL' || searchQuery) && (
              <button
                ...
                className="text-xs text-[#6C3BFF] font-semibold hover:underline px-2"
              >
                Reset
              </button>
            )}
        ...
        {/* Legend */}
        <div className="flex flex-wrap items-center gap-4 text-xs font-medium text-slate-600 mb-6 p-3 bg-slate-50 rounded-xl border border-slate-100">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-3">
            {filteredPlots.map((plot) => {
              const statusStyles = {
                ...
                SOLD: 'bg-purple-50/80 hover:bg-purple-100/80 border-purple-200 text-purple-900',
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <span className="text-[10px] font-semibold px-1.5 py-0.2 rounded bg-white/80 backdrop-blur-xs">
                  ...
                  {plot.customer_name && (
                    <div className="text-[10px] font-semibold truncate text-slate-700 mt-1">
                      👤 {plot.customer_name}
                    </div>
                  )}
                </div>
